...
- **文件预览侧栏** — 点击文件即可预览，右侧侧栏显示：
  ...
  - **Markdown — vscode-office 级阅读体验**：代码高亮、表格、任务列表、Mermaid 图、KaTeX 公式、目录与锚点；18 套亮/暗主题一键切换；可导出 PDF（单页·文字可选）/ HTML / 长图，支持缩放与刷新
...
| Markdown | [markdown-it](https://github.com/markdown-it/markdown-it) + [KaTeX](https://katex.org) / [Mermaid](https://mermaid.js.org) |
...
**Markdown 预览（v1.3.0 重做）** — markdown-it 渲染、代码高亮、Mermaid / 公式、18 套主题，右下角工具条可切主题 / 导出 PDF·HTML·长图 / 缩放 / 刷新：
...
- **File preview sidebar** — click any file to preview it in a resizable right-side panel:
  ...
  - **Markdown — vscode-office-grade reading experience**: syntax highlighting, tables, task lists, Mermaid diagrams, KaTeX math, TOC and anchors; 18 light/dark themes; export to PDF (single page, selectable text) / HTML / long image; with zoom and refresh
...
| Markdown rendering | [markdown-it](https://github.com/markdown-it/markdown-it) + [KaTeX](https://katex.org) / [Mermaid](https://mermaid.js.org) |
...
**Markdown preview (reworked in v1.3.0)** — markdown-it rendering, syntax highlighting, Mermaid / math, 18 themes; a bottom-right toolbar switches theme / exports PDF·HTML·long-image / zoom / refresh:
